            ...
            <form onSubmit={submitform} className=" card p-3 bg-light col-xl-5 col-lg-10 col-md-10 col-sm-10 col-11 mb-7">
                ...
                <div className="row">
                    ...
                    <div>
                        ...
                        <button type="submit" disabled={touched} className="btn btn-success col mt-3">Submit</button>
                        <button type="reset" onClick={reset} className="btn btn-danger col mt-3" >Reset</button></div>
                </div>
            </form>
        </div>
    </Fragment>
